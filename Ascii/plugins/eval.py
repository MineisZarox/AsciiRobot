...
@ascii.on(events.NewMessage(incoming=True, pattern="/asci(?:\s|$)([\s\S]*)"))
@ascii.on(events.MessageEdited(incoming=True, pattern="/pixi(?:\s|$)([\s\S]*)"))
@check_auth
...
@ascii.on(events.NewMessage(incoming=True, pattern="^/dels"))
@ascii.on(events.MessageEdited(incoming=True, pattern="^/dels"))
@check_auth
